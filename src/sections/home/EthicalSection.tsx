...
const EthicalSection = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // ENTRANCE (0% - 30%) - Stronger distance for drama
      scrollTl
        .fromTo(image,
          { opacity: 0, x: '55vw', scale: 1.04 },
  ...
  return (
    <section
      ...
      style={{ zIndex: 50, backgroundColor: '#070A12' }}
    >
      {/* Desktop layout */}
      ...
      <div className="flex lg:hidden flex-col items-center justify-center h-full px-6 gap-8">
        ...
        <div className="w-full max-w-md text-center">
          <span className="micro-label block mb-3">ETHICAL BY DESIGN</span>
          <h2 className="text-3xl sm:text-4xl font-semibold text-white mb-4">Ethical by Design</h2>
